...
fig = plt.gcf()
save_fig('CNN/images', fig, 'car_filters')


# Below, I define the structure of a class called Net that has a convolutional layer that can contain four 4x4
# grayscale filters.
...
model = Net(weight)
print(model)
# print out the layer in the network: Net((conv): Conv2d(1, 4, kernel_size=(4, 4), stride=(1, 1), bias=False))
...
viz_layer(conv_layer, 'car_filtered_versions')

# after a ReLu is applied
# visualize the output of an activated conv layer
viz_layer(activated_layer, 'car_activated_layers')
